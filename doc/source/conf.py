# -*- coding: utf-8 -*-
#
# Coord Utils documentation build configuration file, created by
...
from lsst.sims.coordUtils import __version__
version = __version__
...
htmlhelp_basename = 'CoordUtilsdoc'
...
latex_documents = [
  (master_doc, 'CoordUtils.tex', u'Coord Utils Documentation',
...
man_pages = [
    (master_doc, 'coordutils', u'Coord Utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'CoordUtils', u'Coord Utils Documentation',
   author, 'CoordUtils', 'One line description of project.',
   'Miscellaneous'),
]
