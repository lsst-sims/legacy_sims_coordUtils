...
if __name__ == "__main__":
    ...
    header_msg += '# SIMS_COORDUTILS_DIR/workspace/dm_12447/make_test_catalog.py\n'
    ...
    with open(os.path.join('catalogs', 'lsst_pixel_data.txt'), 'w') as out_file:
    ...
    with open(os.path.join('catalogs', 'lsst_camera_corners.txt'), 'w') as out_file:
        out_file.write(header_msg)
